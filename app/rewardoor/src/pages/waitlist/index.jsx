...
export default function WaitList () {
  return (
    <div
      ...
      className='flex-auto bg-no-repeat bg-cover bg-center flex flex-col justify-center'
    >
      <div className='w-[1280px] mx-auto'>
        <div className='grid grid-cols-2 gap-2.5'>
          ...
          <div className='items-center p-20 rounded-[32px] bg-black/20 drop-shadow border border-white/20 flex flex-col justify-between gap-y-[120px]'>
            <div>
            ...
            <div className='space-y-4 px-[50px] w-full'>
              <button className='bg-[#904BF6] text-white rounded-lg font-zen-dot block py-2 w-full'>
