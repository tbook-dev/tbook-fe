  ...
  return (<div className='space-y-5'>
    <div className='grid grid-cols-4 gap-x-5'>
      {
        participantConf.map((v,idx) => (<div key={idx} className='rounded-2.5xl bg-gray p-5'> 
          <div className='text-[20px] font-black'>{v.value}</div>
    ...
    <div className='bg-gray px-5 pt-5 pb-7 rounded-2.5xl'>
      ...
      <div className='flex items-center gap-x-5 gap-y-4 text-xs'>
        {
          rewardConf.map(v => (<div className='flex items-center justify-between gap-x-5 px-5 py-2 border border-[#666] rounded-2.5xl'>
    ...
    <div className='bg-gray px-5 pt-5 pb-7 rounded-2.5xl'>
      ...
      <div className='flex items-center gap-x-5 gap-y-4 text-xs'>
        {
          mockCredential.map(v => (<div className='flex items-center justify-between gap-x-5 px-5 py-2'>
