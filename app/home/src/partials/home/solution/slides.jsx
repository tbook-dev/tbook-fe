...
import v01 from './solution01.mp4'
import v02 from './solution02.mp4'
import v03 from './solution03.mp4'
import v04 from './solution04.mp4'
    ...
    list: [
      {
        title: (
          <h2>
            Diverse <span className='text-[#006EE9]'>Credential Templates</span>
          </h2>
        ),
      ...
      },
      {
        title: (
          <h2>
            ...
            <span className='text-[#006EE9]'>incentive effect</span>
          </h2>
        ),
      ...
      },
      {
        title: (
          <h2>
            One stop incentive{' '}
            <span className='text-[#006EE9]'>data insight</span> integration
          </h2>
        ),
    ...
    list: [
      {
        title: (
          <h2>
            Build authentic{' '}
            <span className='text-[#006EE9]'>community assets</span>
          </h2>
        ),
      ...
      },
      {
        title: (
          <h2>
            Multiple asset <span className='text-[#006EE9]'>vesting</span>{' '}
            template
          </h2>
        ),
    ...
    list: [
      {
        title: (
          <h2>
            Multiple <span className='text-[#006EE9]'>governance template</span>
          </h2>
        ),
      ...
      },
      {
        title: (
          <h2>
            <span className='text-[#006EE9]'>Governance incentive</span> program
          </h2>
        ),
...
const Slides = (_, ref) => {
  ...
  return pc ? (
    ...
    moduleConf.map((v, idx) => (
      <div
        key={idx}
        className='video-mask relative overflow-hidden line5'
        ref={idx === 0 ? ref : null}
      >
        <VideoPlayer
          src={v.h5Video}
