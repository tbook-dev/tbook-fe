  ...
  const onboarding = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        handle: () => {
          WebApp.openTelegramLink('https://t.me/tbookincentive');
        },
      },
      {
        ...
        handle: () => {
          WebApp.openTelegramLink('https://t.me/tbookofficialgroup');
        },
      },
      {
        title: 'Boost channel',
        ...
        handle: () => {
          WebApp.openTelegramLink('https://t.me/boost/tbookincentive');
        },
      },
    ];
