...
import pointIcon from '@/images/icon/point-white.svg'
    ...
    >
      <div className='flex flex-col items-center'>
        ...
        {data.type === 'nft' ? (
          ...
          <div className='pt-4 flex items-center justify-around w-full'>
            <span className='text-[60px] font-bold'>{data.number}</span>
