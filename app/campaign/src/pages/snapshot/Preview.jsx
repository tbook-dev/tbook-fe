      ...
      <div className='space-y-3'>
        {isLoading ? (
          ...
          choices.map((v, idx) => (
            ...
            >
              <span className='flex-none truncate max-w-[150px] lg:max-w-[450px]'>{v.choiceDesc}</span>
              <span className='flex-none truncate max-w-[calc(100%_-_156px)] lg:max-w-[calc(100%_-_450px)]'>
