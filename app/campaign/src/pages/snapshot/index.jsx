          ...
          <div className="lg:flex space-y-16 lg:space-y-0 lg:gap-x-20">
            {isLoading ? (
              ...
              <div className="space-y-6 lg:space-y-16 lg:w-[calc(100%_-_480px)]">
                {data?.body && <Markdown>{formatIPFS(data?.body)}</Markdown>}

                <div className="space-y-4">
                  <h2 className="text-base font-bold font-zen-dot">
                    Cast your vote
                  </h2>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-x-2">
                      ...
                      <p className="text-xs text-[#717374]">{snapshotPrompt}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:w-[400px] lg:flex-none space-y-3 lg:space-y-4">
              <h2 className="text-base font-bold font-zen-dot">
                Current results
              </h2>
