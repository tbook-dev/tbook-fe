...
export const checkGameAirDrapData = async function () {
  return await request.Post(`${host}/game_airdrop/check`);
};
...
export const getNormis = async function name() {
  ...
  //       activityId: 941,
  //       activityUrl: 'https://society.ton.org/normie-airdrop-toncoin-holder',
  //       picUrl: 'https://static.tbook.vip/img/58f503304c974d5a8c44b9fdfdf666b9',
  //       number: 0,
  //       methodType: 1,
  //       unlimited: true,
  //       rewardNum: 0,
