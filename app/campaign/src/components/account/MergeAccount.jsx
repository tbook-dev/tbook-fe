...
const moduleConf = {
  title: 'Merge the passport accounts',
  button: ['Cancel', 'Merge'],
  desc: 'All data from these 2 accounts will be merged together. This action cannot be undone.',
  getAccountInfo: ({ twitterName ='', address='' }) => {
    return `Are you sure to merge the passport accounts logged in with Twitter @${twitterName} and the logged in with the wallet address ${address}? `
  }
}
