...
const moduleConf = {
  ...
  getAccountInfo: ({ twitterName = '', address = '' }) => {
    return (
      <>
        All data from the incentive passport associated with X @<span className='text-white font-medium'>{twitterName}</span>
        and the incentive passport associated with address $<span className='text-white font-medium'>{address}</span> will be
        merged. 
      </>
    )
  }
