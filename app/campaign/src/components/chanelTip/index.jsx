...
export default function ChanelTip () {
  return (
    <Popover className='group relative'>
      <Popover.Button className='active:outline-none focus-within:outline-none'>
        <img className='tip' src={tipImg} alt='tip img' />
      </Popover.Button>
      <Transition
      ...
      >
        <Popover.Panel
          anchor='bottom'
          className='absolute -translate-x-full -translate-y-full flex flex-col backdrop-blur-md shadow-lg'
        >
          <div className='flex gap-x-3  w-[300px] lg:w-[340px] p-4 rounded-2xl bg-white/5 '>
            <svg
              width='20'
              height='20'
              viewBox='0 0 20 20'
            ...
            <div className='text-sm'>
              ...
              <a
                className='underline text-[#A1A1A2]'
