...
export default function Loading({ className }) {
  return (
    <div
      className={cn(
        'fixed inset-0 h-full overflow-hidden animate-pulse',
        className
      )}
    >
      <SBTIcon className="opacity-80 size-[150px] absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" />
      <SBT20KIcon className="opacity-80 size-[120px] absolute top-12 lg:top-20 left-6" />
      ...
      <SBT500KIcon className="opacity-80 size-[120px] absolute top-80 left-20  lg:left-40" />
      <SBT1MIcon className="opacity-80 size-[100px] absolute top-20 lg:top-10 right-10" />
