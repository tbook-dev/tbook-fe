  ...
  return (
    ...
    >
      <div
        ...
        className={clsx(
          "flex items-center cursor-pointer h-10 px-4 py-2 mr-4 rounded-lg bg-[#f6fafe] dark:bg-none dark:hover:bg-cw1 dark:hover:text-white hover:dark:shadow-d7 text-c1 dark:text-c-9 dark:shadow-d3",
