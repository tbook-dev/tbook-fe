...
import Orders from './pages/incentive/Orders';
import Invoices from './pages/incentive/Invoices';
import Shop from './pages/incentive/Shop';
import Shop2 from './pages/incentive/Shop2';
import Product from './pages/incentive/Product';
import Cart from './pages/incentive/Cart';
import Cart2 from './pages/incentive/Cart2';
import PlanCreate from './pages/incentive/PlanCreate';
import Pay from './pages/incentive/Pay';
