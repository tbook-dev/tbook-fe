...
import { wagmiClient, changeAccountSignIn, logout, chains, authenticationAdapter } from "./utils/web3";
...
function App() {
  ...
  return (
    ...
    <RainbowKitProvider chains={chains} modalSize="compact" authenticationAdapter={authenticationAdapter}>
    <Layout>
      <Routes>
        {routes.map((route) => {
          return (
