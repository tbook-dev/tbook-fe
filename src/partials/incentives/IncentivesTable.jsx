...
import Customer from './IncentivesTableItem';
  ...
  return (
    <div className="bg-white shadow-lg rounded-sm border border-slate-200 relative">
      <header className="px-5 py-4">
        <h2 className="font-semibold text-slate-800">All Incentives <span className="text-slate-400 font-medium">248</span></h2>
      </header>
      <div>
        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full">
            ...
            <thead className="text-xs font-semibold uppercase text-slate-500 bg-slate-50 border-t border-b border-slate-200">
              <tr>
                <th className="px-5 last:pr-3 py-3 w-20">
                ...
                <th className="px-2 first:pl-5 last:pr-5 py-3">
                  <div className="font-semibold text-left">Certificate</div>
                </th>
                <th className="px-2 first:pl-5 last:pr-5 py-3">
                  <div className="font-semibold text-left">Holder</div>
                </th>
                <th className="px-2 first:pl-5 last:pr-5 py-3">
                ...
                <th className="px-2 first:pl-5 last:pr-5 py-3">
                  <div className="font-semibold text-left">Original Quantity</div>
                </th>
                <th className="px-2 first:pl-5 last:pr-5 py-3">
                  <div className="font-semibold text-left">Grant Date</div>
                </th>
                <th className="px-2 first:pl-5 last:pr-5 py-3">
                  <div className="font-semibold">Vesting Schedules</div>
                </th>
                <th className="px-2 first:pl-5 last:pr-5 py-3">
